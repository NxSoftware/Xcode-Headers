...
@class DVTDelayedInvocation, DVTDispatchLock, DVTStackBacktrace, IBCancellationToken, IBLiveViewsBundleBlueprintMap, IBMutableIdentityDictionary, NSCountedSet, NSHashTable, NSMapTable, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSString;
...
- (id)_additionalBuildSettingsForWorkspace:(id)arg1 runDestination:(id)arg2;
