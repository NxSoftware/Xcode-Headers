...
+ (id)ibInspectorPropertySearchDescriptionsForKeyPath:(id)arg1 inInspectors:(id)arg2 idiom:(id)arg3;
+ (id)ibSearchableInspectorsForIdiom:(id)arg1;
...
- (id)ibVisibleAttributeSearchLocationsForKeyPath:(id)arg1 inInspectors:(id)arg2 inDocument:(id)arg3;
...
- (id)ibStringValueForAttributeSearchLocation:(id)arg1 knownToBeVisible:(BOOL)arg2 inInspectors:(id)arg3 inDocument:(id)arg4;
