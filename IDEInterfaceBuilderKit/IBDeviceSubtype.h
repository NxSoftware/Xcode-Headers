...
@property(readonly, nonatomic) NSString *maskIdentifier; // @synthesize maskIdentifier=_maskIdentifier;
...
- (id)initWithIdentifier:(id)arg1 displayName:(id)arg2 scaleFactor:(double)arg3 maskIdentifier:(id)arg4 idiom:(id)arg5 bezelCornerRadius:(id)arg6 bezelCornerRadiusInset:(id)arg7 adaptations:(id)arg8 defaultOrientation:(id)arg9 defaultAdaptationByOrientationMap:(id)arg10;
