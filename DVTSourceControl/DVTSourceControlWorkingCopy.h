...
@class DVTSourceControlAuthor, DVTSourceControlBranchAndTagLocations, DVTSourceControlRemoteRepository, DVTSourceControlRepository, DVTSourceControlRevision, DVTSourceControlRevisionLocation, NSDate, NSDictionary, NSMapTable, NSOperationQueue, NSSet, NSString, NSURL;
...
- (id)applyStash:(id)arg1 index:(BOOL)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (id)deleteStash:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
- (id)stashChanges:(BOOL)arg1 includeUntracked:(BOOL)arg2 message:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
...
- (id)contentsOfUnmodifiedFile:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
