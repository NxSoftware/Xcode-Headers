...
@class DVTBorderedView, DVTObservingToken, IDENavigableItem, IDENavigableItemAsyncFilteringCoordinator, IDENavigatorDataCell, IDEReviewFilesViewController, NSMapTable, NSMutableSet, NSObject, NSOperationQueue, NSString;
