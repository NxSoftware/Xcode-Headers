...
@class DVTNotificationToken, DVTObservingToken, DVTRoundedRectTextField, DVTTableView, IDEProfileQualification, IDEProvisioningProfileInfoViewControllerConfiguration, NSArray, NSLayoutConstraint, NSString, NSTextField, NSView, _IDEProvisioningProfileImageView;
...
@property __weak NSView *headerBackgroundView; // @synthesize headerBackgroundView=_headerBackgroundView;
