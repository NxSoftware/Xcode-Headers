...
@class DVTBorderedView, DVTObservingToken, DVTTextViewWithPlaceholder, IDEEditorDocument, IDESourceControlPushOperationInfo, IDESourceControlRepositoryChooserItem, IDESourceControlReviewFilesDataSource, IDESourceControlWorkspaceUIHandler, NSArray, NSButton, NSImageView, NSMutableArray, NSMutableDictionary, NSObject, NSOperationQueue, NSPopUpButton, NSSplitView, NSString, NSTextField, NSTouchBar;
@protocol OS_dispatch_semaphore;

@interface IDESourceControlCommitWindowController : IDESourceControlReviewFilesWindowController <NSTouchBarProvider, NSTouchBarDelegate, IDENavigableItemCoordinatorDelegate>
{
