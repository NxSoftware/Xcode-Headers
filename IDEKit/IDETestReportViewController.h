...
@class DVTLozengeTextField, DVTObservingToken, DVTOutlineView, DVTReplacementView, IDETestReportAttachmentsSupport, IDETestReportRemoteAssetDownloader, IDETestReportStateSaving, NSArray, NSDictionary, NSMapTable, NSMutableArray, NSMutableIndexSet, NSPopover, NSScrollView, NSString, NSView;
@protocol IDETestReport_RootObject;

@interface IDETestReportViewController : IDEViewController <NSOutlineViewDelegate, NSOutlineViewDataSource, NSPopoverDelegate, IDETestsInTestableObserver>
{
...
- (void)extractFirstAttachmentIn:(id)arg1 withBlock:(CDUnknownBlockType)arg2;
- (void)processAttachment:(id)arg1 activity:(id)arg2 withBlock:(CDUnknownBlockType)arg3;
