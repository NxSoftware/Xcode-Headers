...
@class DVTBorderedView, DVTObservingToken, DVTStackBacktrace, IDELocalizationImportContext, IDELocalizationImporter, IDENavigableItem, IDENavigableItemAsyncFilteringCoordinator, IDENavigatorDataCell, IDEReviewFilesViewController, NSMutableDictionary, NSMutableSet, NSString;
