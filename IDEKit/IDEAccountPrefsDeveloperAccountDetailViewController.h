...
@class DVTBorderedView, DVTTableView, IDEAccountDetailsRefresher, IDEProvisioningProfileBulkDownloader, NSArrayController, NSImageView, NSObjectController, NSSet, NSView;
