...
@class DVTBorderedView, DVTOutlineViewWithCustomGridDrawing, IDESearchFilterControlBar, NSArray, NSImageView, NSMutableIndexSet, NSString, NSTextField, NSTreeController, NSView;
