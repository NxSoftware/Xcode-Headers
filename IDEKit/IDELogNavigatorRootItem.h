...
@class DVTDocumentLocation, DVTFileDataType, IDEFileReference, IDELogManager, IDELogNavigatorItem, IDENavigableItemCoordinator, IDEWorkspace, NSArray, NSImage, NSMutableArray, NSNull, NSString, NSURL, _TtC13DVTFoundation9DVTSymbol;
