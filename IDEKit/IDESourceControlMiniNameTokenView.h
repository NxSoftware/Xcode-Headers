...
@protocol IDESourceControlMiniNameTokenViewDelegate;

@interface IDESourceControlMiniNameTokenView : NSView <NSMenuDelegate, NSAccessibilityButton>
{
    NSString *_value;
    ...
    BOOL _showToken;
    BOOL _selected;
    NSObject<IDESourceControlMiniNameTokenViewDelegate> *_delegate;
...
@property __weak NSObject<IDESourceControlMiniNameTokenViewDelegate> *delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
