...
@class DVTBorderedView, DVTChooserView, DVTDocumentLocation, DVTScopeBarView, IDENavigatorOutlineView, IDENavigatorSearchFilterControlBar, NSArray, NSIndexSet, NSMenu, NSMutableArray, NSMutableIndexSet, NSMutableSet, NSString, NSTabView, NSTableColumn, NSVisualEffectView;
...
@interface IDEReviewFilesNavigator : IDENavigator
{
    ...
    NSVisualEffectView *_scopeBackdropView;
