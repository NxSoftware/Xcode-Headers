...
@class DVTObservingToken, IDEWorkspaceDFRDebugBarItemFactory, IDEWorkspaceWindowController, NSButton, NSPointerArray, NSPopoverTouchBarItem, NSString;

@interface IDEWorkspaceDFRController : NSObject <IDEWorkspaceDFRDebugBarItemFactoryControlDelegate>
{
...
- (id)_activeDebugBar;
- (void)_invokeMemoryGraphDebugger;
- (id)_makeMemoryGraphDebugButton;
- (void)_invokeViewDebugger;
- (id)_makeViewDebugButton;
