...
#import <IDEFoundation/IDERunDestinationWithName.h>
...
@interface IDERunDestinationWithName (IDENavigableItemAdditions) <IDEKeyDrivenNavigableItemRepresentedObject>
