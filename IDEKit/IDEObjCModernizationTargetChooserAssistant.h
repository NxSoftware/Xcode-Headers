...
@class DVTBorderedView, DVTOutlineViewWithCustomGridDrawing, IDEMigrationTargetChooserStatePersistence, IDESearchFilterControlBar, NSArray, NSImageView, NSMutableIndexSet, NSString, NSTextField, NSTreeController, NSView;
