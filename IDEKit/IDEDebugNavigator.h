...
@class DVTGradientImageButton, DVTNotificationToken, DVTObservingToken, IDENavigatorOutlineView, IDENavigatorSearchFilterControlBar, NSArray, NSLayoutConstraint, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSView;
