...
@class DVTBorderedView, DVTDelayedInvocation, DVTGradientImageButton, DVTNotificationToken, DVTObservingToken, DVTReplacementView, DVTStepperTextField, GTFActionEditor, GTFActionLibrary, GTFFileSystemEventStream, NSArray, NSButton, NSImage, NSMutableArray, NSMutableDictionary, NSString, NSTextField, SKDocumentBorderedView, SKDocumentScopeBarView, SKDocumentSplitView, SKInputView, SKScene, SKSceneDocument, SKSceneEditController, SKSceneOutlineViewController, SKSceneOverlayView;
@protocol NSObject;
