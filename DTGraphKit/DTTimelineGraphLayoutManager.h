...
@class CALayer, CATextLayer, DTTimelineGraph, DTTimelineGraphLayoutManagerLayerDelegate, NSArray, NSColor, NSSet, NSString;
...
@interface DTTimelineGraphLayoutManager : NSObject <CALayoutManager>
{
    ...
    NSArray *_postLayoutClientActions;
}

@property(retain, nonatomic) NSArray *postLayoutClientActions; // @synthesize postLayoutClientActions=_postLayoutClientActions;
