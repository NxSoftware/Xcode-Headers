...
@interface DBGThreadsStacksContentDelegate : NSObject <DVTFilterTokenFieldControllerDelegate, IDEDebugNavigableContentDelegate, DVTInvalidation>
{
...
- (void)configureMenuForViewOutlineStructurePopUpCell:(id)arg1;
...
- (id)_createViewDebuggerTableCellViewForFetchedDocument:(id)arg1 withOutlineView:(id)arg2;
- (id)_createViewDebuggerTableCellViewForApplicationObject:(id)arg1 withOutlineView:(id)arg2;
- (id)_createViewDebuggerTableCellViewForViewSurface:(id)arg1 withOutlineView:(id)arg2;
- (id)_createViewDebuggerTableCellViewForSnapshotNode:(id)arg1 withOutlineView:(id)arg2;
