...
@class DVTBorderedView, DVTGradientImagePopUpButton, DVTMacroDefinitionConditionSet, DVTObservingToken, DVTPerformanceMetric, DVTSearchField, DVTSourceExpression, NSArray, NSButton, NSMenu, NSMutableArray, NSMutableDictionary, NSMutableSet, NSOutlineView, NSScrollView, NSString, PBXProject, XCPropertyDefinition, Xcode3BuildPropertyEditor, Xcode3BuildPropertyOutlineView, Xcode3ConfigurableDataSource, Xcode3ProjectEditor;
