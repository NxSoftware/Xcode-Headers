...
#import <IDESourceCodeComparisonEditor/DVTSourceCodeComparisonTextView-Protocol.h>

@class NSColor;

@interface __T012SourceEditor0aB11ContentViewCN (IDESourceCodeComparisonEditor) <DVTSourceCodeComparisonTextView>
