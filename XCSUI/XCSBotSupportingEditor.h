...
@interface XCSBotSupportingEditor : IDEEditor <DVTReplacementViewDelegate>
{
    ...
    struct CGRect _integrateButtonFrameNormal;
    struct CGRect _editButtonFrameNormal;
    ...
    DVTObservingToken *_documentErrorObserver;
...
@property(retain) DVTObservingToken *documentErrorObserver; // @synthesize documentErrorObserver=_documentErrorObserver;
