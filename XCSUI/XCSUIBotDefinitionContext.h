...
@class DVTObservingToken, DVTSourceControlWorkspaceBlueprint, IDEScheme, IDEWorkspace, IDEWorkspaceTabController, NSArray, NSDictionary, NSError, NSMapTable, NSSet, NSString, NSURL, XCSArchiveExportOptions, XCSBot, XCSDeviceSpecification, XCSProvisioningConfiguration, XCSService, XCSToolchain, XCSUIDevicesContext;
