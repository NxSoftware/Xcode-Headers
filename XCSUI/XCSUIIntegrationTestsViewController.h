...
@class DVTBorderedView, DVTLozengeTextField, DVTSplitView, IDETestReportTestRunFetcher, NSArray, NSError, NSString, XCSBot, XCSBotSupportingEditor, XCSIntegration, XCSUIProgressReplacementView;
