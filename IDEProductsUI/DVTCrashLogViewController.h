...
@interface DVTCrashLogViewController : IDEViewController <NSOutlineViewDataSource, NSOutlineViewDelegate, DVTFindBarHostable, DVTScopeBarHost>
{
...
- (void)find:(id)arg1;
- (void)productsContextMenu_symbolicateCrashLog:(id)arg1;
- (void)productsContextMenu_showCrashLogInFinder:(id)arg1;
