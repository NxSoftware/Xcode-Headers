...
@class DVTBorderedView, DVTCrashPoint, DVTCrashPointSource, DVTCrashPointSourceCollection, DVTDelayedInvocation, DVTDispatchLock, DVTNotificationToken, DVTObservingToken, DVTTableView, DVTUserDefaultsLeastRecentlyUsedCache, IDECrashPointSourceCollectionSelector, IDECrashPointsViewController, IDESearchFilterControlBar, NSArray, NSArrayController, NSIndexSet, NSMutableDictionary, NSScrollView, NSString, NSView;
...
@interface IDECrashPointSourceListViewController : IDEViewController <IDEFilterControlBarTarget, DVTTableViewDelegate, NSMenuDelegate>
{
    ...
    IDESearchFilterControlBar *_crashPointsFilterControlBar;
    ...
    DVTDelayedInvocation *_delayedUpdateCrashPointsDisplayInvocation;
    ...
    DVTCrashPointSource *_lastRepresentativeCrashPointSource;
...
@property(retain, nonatomic) DVTCrashPointSource *lastRepresentativeCrashPointSource; // @synthesize lastRepresentativeCrashPointSource=_lastRepresentativeCrashPointSource;
...
@property(retain) DVTDelayedInvocation *delayedUpdateCrashPointsDisplayInvocation; // @synthesize delayedUpdateCrashPointsDisplayInvocation=_delayedUpdateCrashPointsDisplayInvocation;
...
@property __weak IDESearchFilterControlBar *crashPointsFilterControlBar; // @synthesize crashPointsFilterControlBar=_crashPointsFilterControlBar;
...
- (void)_updateCrashPointsFromNetworkForSource:(id)arg1 window:(id)arg2 accountsPreviouslyFailed:(id)arg3 accountsCurrentlyFailed:(id *)arg4 errors:(id *)arg5;
