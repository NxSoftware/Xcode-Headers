...
{
    StateMirrorManager_ed1ed949 _manager;
...
- (id)_addTextureObject:(const void *)arg1 toParent:(id)arg2 textureObjectID:(unsigned int)arg3 layerIndex:(unsigned int)arg4 attachment:(unsigned int)arg5 context:(const ContextStateMirror_35fc3168 *)arg6 prefix:(const char *)arg7;
- (id)_addObjectToParent:(id)arg1 objectID:(unsigned int)arg2 objectInternalID:(unsigned int)arg3 target:(unsigned int)arg4 attachment:(int)arg5 indexType:(unsigned int)arg6 context:(const ContextStateMirror_35fc3168 *)arg7 prefix:(const char *)arg8 annotations:(id)arg9;
- (id)_createGPUTraceResourceItemWithParent:(id)arg1 object:(const void *)arg2 objectID:(unsigned int)arg3 labelTarget:(unsigned int)arg4 context:(const ContextStateMirror_35fc3168 *)arg5 prefix:(const char *)arg6 suffix:(const char *)arg7 type:(unsigned int)arg8;
- (id)_createGPUTraceResourceItemWithParent:(id)arg1 object:(const void *)arg2 objectID:(unsigned int)arg3 labelTarget:(unsigned int)arg4 context:(const ContextStateMirror_35fc3168 *)arg5 prefix:(const char *)arg6 type:(unsigned int)arg7;
...
- (void)_createShaderResourcesForProgramItem:(id)arg1 forProgram:(const ProgramObject_81ee481a *)arg2;
- (id)_identifierForObject:(unsigned long long)arg1 context:(const ContextStateMirror_35fc3168 *)arg2 target:(unsigned int)arg3 prefix:(const char *)arg4 suffix:(const char *)arg5;
- (const ContextStateMirror_35fc3168 *)contextStateMirror;
- (const FramebufferObject_36862a27 *)currentDisplayableFrameBuffer;
- (const TextureObject_ec847b4b *)textureObjectFromInternalID:(int)arg1;
...
@property(readonly, nonatomic) StateMirrorManager_ed1ed949 *manager;
