...
- (id)initWithStdoutHandler:(CDUnknownBlockType)arg1 stderrHandler:(CDUnknownBlockType)arg2 completionHandler:(CDUnknownBlockType)arg3;
@property(nonatomic, readonly) OS_dispatch_queue *outputQueue; // @synthesize outputQueue;
@property(nonatomic, readonly) CDUnknownBlockType stderrHandler; // @synthesize stderrHandler;
@property(nonatomic, readonly) CDUnknownBlockType stdoutHandler; // @synthesize stdoutHandler;
