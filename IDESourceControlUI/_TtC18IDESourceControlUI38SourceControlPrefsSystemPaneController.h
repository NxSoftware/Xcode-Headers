...
@class DVTBorderedView, DVTGradientImageButton, DVTSourceControlSystem, DVTTableView, IDEControlGroup, NSArray, NSButton, NSString, NSTextField;
...
@property(nonatomic, copy) NSArray *ignoredFiles; // @synthesize ignoredFiles;
@property(nonatomic, retain) DVTSourceControlSystem *system; // @synthesize system;
@property(nonatomic) BOOL doneLoadingIgnoredFiles; // @synthesize doneLoadingIgnoredFiles;
@property(nonatomic) BOOL doneLoadingAuthor; // @synthesize doneLoadingAuthor;
