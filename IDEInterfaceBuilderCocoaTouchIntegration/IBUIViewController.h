...
@interface IBUIViewController : IBAbstractViewController <IBDocumentArchiving, IBUISimulatedMetricsIntegratedObject, IBIDEUIViewControllerAutolayoutGuideDelegate, IBUISimulatedMetricsObject, IBUIViewControllerAutolayoutGuideDelegate, IBSceneUpdateRequestConfiguring>
{
