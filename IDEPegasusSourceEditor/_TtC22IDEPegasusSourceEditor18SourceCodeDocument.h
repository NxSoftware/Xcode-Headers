...
@class DVTObservingToken, DVTSourceCodeLanguage, IDEMediaResourceVariantContext, NSArray, NSDictionary, NSPrintInfo, NSString, NSURL, _TtC18SourceModelSupport26SourceModelLanguageService, _TtC22IDEPegasusSourceEditor18SourceCodeLandmark;
@protocol DVTCancellable;

@interface _TtC22IDEPegasusSourceEditor18SourceCodeDocument : IDEEditorDocument <IDESourceCodeGenerationDestination, DVTSourceLanguagePrimaryCompletionStrategy, IDESourceCodeDocument, IDEDocumentStructureProviding, DVTTextFindable, DVTTextReplacable, IDEMediaLibraryDelegate, DVTSourceModelProvider>
{
...
@property(nonatomic) BOOL indentReplacements; // @synthesize indentReplacements;
...
@property(nonatomic, retain) id <DVTCancellable> inFlightExtensionCommandTimer; // @synthesize inFlightExtensionCommandTimer;
@property(nonatomic, retain) id <DVTCancellable> inFlightExtensionCommandToken; // @synthesize inFlightExtensionCommandToken;
...
- (void)invalidateLandmarkTimer;
- (void)queueLandmarksUpdate;
- (void)updateLandmarks;
@property(nonatomic, readonly) BOOL landmarksAreCurrent;
@property(nonatomic, readonly) _TtC22IDEPegasusSourceEditor18SourceCodeLandmark *topLandmark;
- (id)landmarkAt:(id)arg1;
- (id)updatedLocationFromLocation:(id)arg1 toTimestamp:(double)arg2;
- (id)indexCompatibleDocumentLocationFrom:(id)arg1;
- (void)buildSettingsChanged;
- (void)indexChanged:(id)arg1;
- (void)asynchronouslyLoadBuildSettingsFor:(id)arg1 notification:(id)arg2;
...
@property(nonatomic, copy) NSURL *contentReadFromURL; // @synthesize contentReadFromURL;
- (void)unregisterContentStateObserverWith:(id)arg1;
- (BOOL)isGeneratingContent;
@property(nonatomic, retain) DVTSourceCodeLanguage *language; // @synthesize language;
@property(nonatomic) BOOL usesInferredLanguage; // @synthesize usesInferredLanguage;
...
@property(nonatomic, copy) NSDictionary *firstEditorWorkspaceBuildSettings; // @synthesize firstEditorWorkspaceBuildSettings;
@property(nonatomic, retain) DVTObservingToken *firstEditorWorkspaceObservingToken; // @synthesize firstEditorWorkspaceObservingToken;
