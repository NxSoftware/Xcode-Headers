...
#import <IDEPegasusSourceEditor/DVTMarkedScrollerDelegate-Protocol.h>
#import <IDEPegasusSourceEditor/DVTSourceCodeLanguageEditorView-Protocol.h>
#import <IDEPegasusSourceEditor/DVTTextCompletionSupportingTextView-Protocol.h>

@class DVTSourceCodeLanguage, DVTTextCompletionController, DVTTextCompletionDataSource, NSScrollView, NSString, _TtC22IDEPegasusSourceEditor16SourceCodeEditor;

@interface _TtC22IDEPegasusSourceEditor20SourceCodeEditorView : __T012SourceEditor0aB4ViewCN <DVTTextCompletionSupportingTextView, DVTSourceCodeLanguageEditorView, DVTMarkedScrollerDelegate>
{
...
- (void)setMarkedScrollerNeedsUpdate;
...
- (void)gutterAnnotationsDidChange;
- (void)lineAnnotationsDidChange;
