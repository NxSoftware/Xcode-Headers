...
@class DVTDocumentLocation, IDEActivityLogSectionRecorder, IDESchemeActionCodeCoverage, IDETypeIdentifier, NSArray, NSData, NSMapTable, NSMutableArray, NSMutableString, NSString, NSURL;
