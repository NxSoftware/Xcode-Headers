...
#import <IDEFoundation/IDEOpenQuicklyIndexSymbol-Protocol.h>

@class DVTFilePath, DVTSourceCodeLanguage, DVTSourceCodeSymbolKind, IDEIndexCollection, NSObject, NSString, _TtC13DVTFoundation9DVTSymbol;
@protocol IDEIndexQueryProvider;

@interface IDEIndexSymbol : IDEIndexSymbolOccurrence <IDEOpenQuicklyIndexSymbol, IDEAutoImportable>
{
    NSString *_name;
