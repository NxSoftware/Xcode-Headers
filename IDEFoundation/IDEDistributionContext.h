...
@class DVTDeveloperAccount, DVTDeveloperAccountManager, DVTLogAspect, DVTMutableOrderedDictionary, DVTProvisioningProfileManager, DVTSigningCertificateManager, IDEAppStoreSubmissionConfiguration, IDEArchive, IDEDistributionLogging, IDEDistributionManifest, IDEDistributionMethod, IDEDistributionProcessingPipeline, IDEDistributionProvisioningEvaluation, IDEDistributionProvisioningManualSigningMap, IDEProvisioningTeamManager, NSArray, NSMutableOrderedSet, NSMutableSet, NSNumber, NSSet, NSURL;
@protocol IDEProvisioningBasicTeam, ITunesSoftwareApplicationDescription, ITunesSoftwareServiceConfigurationResponse;
