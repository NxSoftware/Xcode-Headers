...
- (void)openIndex:(id)arg1 workspaceFile:(id)arg2 indexFolder:(id)arg3 datastoreFolder:(id)arg4 databaseFolder:(id)arg5 pchHeaderFolder:(id)arg6 buildConfig:(id)arg7 destinationTargetIdentifier:(id)arg8 indexDatabasePath:(id)arg9 useBolt:(BOOL)arg10 enableFullStoreVisibility:(id)arg11 queue:(id)arg12 completion:(CDUnknownBlockType)arg13;
- (id)openIndex:(id)arg1 workspaceFile:(id)arg2 indexFolder:(id)arg3 datastoreFolder:(id)arg4 databaseFolder:(id)arg5 pchHeaderFolder:(id)arg6 buildConfig:(id)arg7 destinationTargetIdentifier:(id)arg8 indexDatabasePath:(id)arg9 useBolt:(BOOL)arg10 enableFullStoreVisibility:(id)arg11 error:(id *)arg12;
