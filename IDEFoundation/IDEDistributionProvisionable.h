...
@class DVTPlatform, IDEDistributionItem, IDEDistributionMethod, IDEDistributionProvisioningEntitlementsExpansion, IDEProfileSpecifier, NSDictionary, NSOrderedSet, NSString;
