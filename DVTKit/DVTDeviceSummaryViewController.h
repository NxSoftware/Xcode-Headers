...
@class DVTBorderedView, DVTDevice, DVTDeviceSummaryAboutViewController, DVTDeviceSummaryAppsViewController, DVTGradientImageButton, DVTStackBacktrace, DVTStackView_AppKitAutolayout, DVTTableView, NSArray, NSButton, NSImageView, NSMutableArray, NSMutableDictionary, NSScrollView, NSSet, NSString, NSTextField, NSView;
