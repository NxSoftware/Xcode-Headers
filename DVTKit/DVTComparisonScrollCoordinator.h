...
@class DVTBorderedView, DVTComparisonScroller, DVTComparisonSplitView, NSArray, NSIndexSet, NSScrollView, NSScrollerImpPair, NSString, NSView;
@protocol DVTSourceCodeComparisonTextView;
...
- (void)computeTotalScrollSize:(BOOL)arg1 fromSide:(int)arg2;
- (void)computeTotalScrollSize:(BOOL)arg1;
