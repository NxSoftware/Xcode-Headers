...
@class DVTStackBacktrace, DYGLCaptureSessionInfo, GPUDebuggerController, GPUTraceDisplayableItem, GPUTraceProcessItem, GPUTraceSession, NSArray, NSMapTable, NSMutableArray, NSMutableDictionary, NSString;
