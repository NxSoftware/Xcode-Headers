...
@class DVT_VMUClassInfoMap, DVT_VMUNonOverlappingRangeArray, DVT_VMUTaskMemoryScanner, NSArray, NSHashTable, NSMapTable, NSMutableDictionary, NSMutableSet, NSString;
